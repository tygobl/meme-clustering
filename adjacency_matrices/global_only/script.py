...
combined_matrix =  normalized_matrices['BERT_NGRAMS'] + normalized_matrices['VIT'] + normalized_matrices['HISTO'] + normalized_matrices['PHASH']

# # Ensure both matrices are in the same format, e.g., CSR
combined_matrix = combined_matrix.tocsr()

save_npz(f'adjacency_matrices/global_only/adjacency_matrix.npz', combined_matrix)