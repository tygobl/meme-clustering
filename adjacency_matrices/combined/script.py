...
combined_matrix =  normalized_matrices['FACES'] + normalized_matrices['SURF_NO_TEXT']  + normalized_matrices['BERT_NGRAMS'] + normalized_matrices['VIT'] + normalized_matrices['HISTO'] + normalized_matrices['PHASH']

save_npz(f'adjacency_matrices/combined/adjacency_matrix.npz', combined_matrix)